...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.etiket_hiz.setText(_translate("MainWindow", "Hız Göstergesi"))
        ...
        self.etiket_lineer.setText(_translate("MainWindow", "Lineer Hız (m/s):"))
        self.etiket_acisal.setText(_translate("MainWindow", "Açısal Hız (rad/s):"))
